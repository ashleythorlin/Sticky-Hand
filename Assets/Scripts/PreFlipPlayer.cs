...
public class PreFlipPlayer : MonoBehaviour
{
    ...
    {
        if ((Input.GetKeyDown("w") || Input.GetKeyDown("space")) && !connected && !isGrounded) {
            _animator.Play($"player_jump_{direction}");
        }
        //move left
        else if (Input.GetKey("a") && !connected && isGrounded) {
            _animator.Play($"player_walk_{direction}");
        // move left on grapple
        } else if (Input.GetKey("a") && connected && !grappling) {
            _animator.Play($"player_idle_{direction}");
        }
        ...
        //move right
        else if (Input.GetKey("d") && !connected && isGrounded) {
            _animator.Play($"player_walk_{direction}");
        //move right on grapple
        } else if (Input.GetKey("d") && connected && !grappling) {
            _animator.Play($"player_idle_{direction}");
            ...
            _animator.Play($"player_fall_{direction}");
        }
        else {
           _animator.Play($"player_idle_{direction}");
        }
